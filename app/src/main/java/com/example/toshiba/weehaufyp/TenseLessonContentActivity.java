...
public class TenseLessonContentActivity extends Activity implements View.OnClickListener{
    ...
    TextView presentTimeButton, futureTimeButton, pastTimeButton, presentPerfectButton;

    //variables for db
    private String presentTimeConsolidationLessonContent = "<b><u>Basic contrasts: present simple and present continuous</u></b><br>" +
            "1.\t<u>Present simple</u> generally refers to:<br><br>" +
            "<u>Facts that are always true</u>:<br>[Water <b>boils</b> at 100 degrees Celsius.]<br><br>" +
    ...
    private String futureTimeConsolidationLessonContent = "<b><u>Basic contrasts: will, going to, present continuous</u></b><br>" +
            "1.\t<u>“Will” is normally known as the predictive future</u>, and describes known facts, or what we suppose is true.<br><br>" +
            ...
            "<br>" +
            "2.\t<u>“Will” is also used to express an immediate decision.</u><br>" +
            "[I’<b>ll</b> take this one.]<br>" +
            "<br>" +
            "3.\t<u>“Be going to” describes intentions or plans.</u><br>At the moment of speaking the plans have already been made.<br>" +
            ...
            "<br>" +
            "4.\t<u>Present continuous describes fixed arrangements</u>, especially social and travel arrangements.<br><br>A time reference is usually included.<br>Note the strong similarity to the “going to” future.<br><br>" +
            "[I <b>am having</b> a party next week]<br>and<br>[I <b>am going to have</b> a party next week]<br>are communicating the same message.<br><br><br>" +
            "<b><u>Future continuous</u></b><br>" +
            "1.\t<u>This describes an event which will be happening at a future point.</u><br>" +
            "[Come round in the morning. I'<b>ll be painting</b> in the kitchen.]<br>" +
            "<br>" +
            "2.\t<u>It can also describe events which are going to happen anyway</u>, rather than events which we choose to make happen.<br><br>" +
            "[I won't bother to fix a time to see you, because I'<b>ll be calling</b> into the office anyway several times next week.]<br>" +
            "<br>" +
            "3.\t<u>In some contexts future continuous also sounds more polite than “will”</u>.<br>" +
            "[<b>Will</b> you <b>be going</b> to the shops later? If you go, could you get me some milk?]<br>" +
            "<br>" +
            "4.\t<u>It can also be used to refer to fixed arrangements and plans.</u><br>" +
            "[The band <b>will be performing</b> live in Paris this summer.]<br><br><br>" +
            "<b><u>Future perfect</u></b><br>" +
            "1.\t<u>This has both simple and continuous forms, and refers to time which we look back at from a future point.</u><br><br>" +
            ...
            "<br>" +
            "2.\t<u>It can also be used to express an assumption on the part of the speaker.</u><br><br>" +
    ...
    private String pastTimeConsolidationLessonContent = "<b><u>Basic contrasts: past simple and past continuous</u></b><br>" +
            "1.\t<u>Past simple</u> generally refers to:<br><br>" +
            "<u>Completed actions</u>:<br>[I <b>got</b> up, <b>switched</b> off the radio, and <b>sat</b> down again.]<br><br>" +
            "<u>Habits</u>:<br>[Every day I <b>went</b> to the park.]<br><br>" +
            "<u>States</u>:<br>[In those days, I <b>didn't like</b> reading.]<br>" +
            "<br>" +
            "2.\t<u>Past continuous (progressive)</u> generally refers to:<br><br>" +
            "<u>Actions in progress (often interrupted by events)</u><br>" +
            "[I <b>was drinking</b> my coffee at the time.]<br>" +
            "[While I <b>was opening</b> the letter, the phone rang.]<br>" +
            "<br>" +
            "<u>Background description in narrative</u><br>" +
            ...
            "<br>" +
            "<u>Repeated actions - criticism</u><br>" +
            ...
            "<br>" +
            "3.\t<u>Past continuous is not used to describe general habitual actions, without the sense of criticism mentioned above.</u><br>Past simple is used for this meaning.<br><br>" +
            "[When I lived in London, I <b>walked through</b> the park every day.]<br><br><br>" +
            "<b><u>Past perfect simple and continuous</u></b><br>" +
            "1.\t<u>We use the past perfect when we are already talking about the past, and we want to go back to an earlier past time ('double past').</u><br>" +
            "[By the time I got to the station, the train <b>had left</b>.]<br>" +
            "<br>" +
            "2.\t<u>Past perfect continuous (progressive)</u><br>" +
            ...
            "[The whole place was deserted, but it was obvious that someone <b>had been living</b> there. They'<b>d been cooking</b> in the kitchen for a start, and they <b>hadn't bothered</b> to clear up the mess.]<br><br><br>" +
            ...
            "[Every week he'<b>d buy</b> his mother a bunch of flowers.]<br><br><br>" +
            "<b><u>Unfulfilled past events</u></b><br>" +
            "1.\t<u>These describe events intended to take place, but which did not happen.</u><br><br>" +
            ...
            "<br>" +
            "2.\t<u>The contrasting past event is often understood, but not stated.</u><br><br>" +
            "[How are you? I <b>was going to</b> phone you.] (but I didn't).<br>" +
            "<br>" +
            "3.\t<u>Polite forms</u><br>" +
    ...
    private String presentPerfectConsolidationLessonContent = "<b><u>Present perfect simple</u></b><br>" +
            "1.\t<u>Present perfect simple</u> refers to:<br><br>" +
            "<u>Recent events</u>, without a definite time given. The recentness may be indicated by “just”.<br>" +
            "[We'<b>ve missed</b> the turning.]<br>" +
            "[I'<b>ve just</b> seen a ghost!]<br>" +
            "<br>" +
            "<u>Indefinite events, which happened at an unknown time in the past.</u> No definite time is given.<br>" +
            "[Jim <b>has had</b> three car accidents.] (up to the present)<br>" +
            "<br>" +
            "<u>Indefinite events which may have an obvious result in the present</u>:<br>[I'<b>ve twisted</b> my ankle] (that's why I'm limping)<br><br>" +
            "<u>With state verbs, a state which lasts up to the present</u>:<br>[I'<b>ve lived</b> here for the past ten years.]<br><br>" +
            "<u>A habitual action in a period of time up to the present</u>:<br>[I'<b>ve been jogging</b> every morning for the last month.]<br>" +
            "<br>" +
            "2.\t<u>Contrast with past simple</u><br>" +
            "Past simple is used with time expressions which refer to definite times. The time may be stated or understood.<br><br>Compare:<br>" +
            ...
            "The speaker may feel separated in time from the event, or be further away.<br><br><br>" +
            "<b><u>Present perfect continuous</u></b><br>" +
            "1.\t<u>Present perfect continuous (progressive)</u> can refer to a range of meanings, depending on the time expression used and the context.<br>" +
            "<br>" +
            ...
            "<br>" +
            "2.\t<u>Contrasts with present perfect simple</u><br>" +
            ...
            "Incomplete, or recently completed: emphasis on duration.<br>[I'<b>ve been ironing</b> my shirts this morning.]<br><br><br>" +
            "<b><u>Time expressions with present perfect</u></b><br>" +
            "Meaning with present perfect verb forms is associated with certain time expressions.<br>" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presentTimeButton = (TextView)findViewById(R.id.present_time_button);
        futureTimeButton = (TextView)findViewById(R.id.future_time_button);
        pastTimeButton = (TextView)findViewById(R.id.past_time_button);
        presentPerfectButton = (TextView)findViewById(R.id.present_perfect_button);
    ...
    public void onClick(View v){
        switch(v.getId()) {
            case R.id.present_time_button :
                ...
                pastTimeButton.setBackgroundColor(Color.parseColor("#404040"));
                presentPerfectButton.setTextColor(Color.parseColor("#e5e5e5"));
                presentPerfectButton.setBackgroundColor(Color.parseColor("#404040"));
